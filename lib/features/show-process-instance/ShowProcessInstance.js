...
//var DataPanel = require('../data-panel/DataPanel')
function isNull(value) {
  return value === null;
}

function ShowProcessInstance(eventBus, canvas,  processInstanceSettings, processInstances, graphicsFactory, elementRegistry, dataPanel) {
  var self = this;
...
ShowProcessInstance.prototype._init = function() {
  this.container = domify('<div id="process-instances" class="process-instances hidden"></div>');
...
ShowProcessInstance.prototype.addInstance = function(context) {
  ...
  var element = domify(
    '<div id="instance" class="process-instance" title="View Process Instance ' + processInstanceId + '">' +
    processInstanceId +
    '</div>'
  );
...
ShowProcessInstance.prototype.addHighlightToProcess = function(element) {
  this.setColor(element, '#52b415', '#bfa10080');
...
ShowProcessInstance.$inject = ['eventBus', 'canvas', 'processInstanceSettings', 'processInstances', 'graphicsFactory', 'elementRegistry', 'dataPanel'];
