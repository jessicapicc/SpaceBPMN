...
module.exports = function(element, bpmnFactory, options, translate) {
  ...
  assign(options, {
    addLabel: translate('Add Message Field'),
    ...
    addElement: function(element, node) {
      ...
      if (!properties) {
        properties = elementHelper.createElement('mida:Message', {}, parent, bpmnFactory);

        if (!isExtensionElements(parent)) {
          commands.push(cmdHelper.updateBusinessObject(element, parent, { 'message': properties }));
        } else {
      ...
      var property = elementHelper.createElement('mida:Field', propertyProps, properties, bpmnFactory);
